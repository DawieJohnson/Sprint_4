...
public class MainPageOrderButtonTest {
    ...
    //конструктор класса
    public MainPageOrderButtonTest(String selectButton){
    ...
    public void testButtonOrder() {
        ...
        assertTrue(pageScooterOrderForWho.pageIsDisplayed()); //проверили, что перешли в окно оформления заказа
    }
